...
// These functions are ignored because they are not marked as `pub`: `convert`, `from_peer_device`, `route_to_rust_route`
...
}) => RustLib.instance.api.crateApiVntApiVntInit(
  vntConfig: vntConfig,
  call: call,
);
...
void initLogWithPath({required String logDir, required String configPath}) =>
    RustLib.instance.api.crateApiVntApiInitLogWithPath(
      logDir: logDir,
...
abstract class VntApi implements RustOpaqueInterface {
  ...
  static Future<VntApi> newInstance({
    required VntConfig vntConfig,
    required VntApiCallback call,
  }) => RustLib.instance.api.crateApiVntApiVntApiNew(
    vntConfig: vntConfig,
    call: call,
  );
...
class RustConnectInfo {
  ...
  const RustConnectInfo({required this.count, required this.address});
...
class RustDeviceInfo {
  ...
  const RustDeviceInfo({required this.name, required this.version});
...
class RustErrorInfo {
  ...
  const RustErrorInfo({required this.code, this.msg});
...
class RustHandshakeInfo {
  ...
  const RustHandshakeInfo({this.finger, required this.version});
