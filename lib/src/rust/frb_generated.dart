...
abstract class RustLibApi extends BaseApi {
  VntApiCallback crateApiVntApiVntApiCallbackNew({
    ...
    required FutureOr<void> Function(List<RustPeerClientInfo>) peerClientListFn,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiVntApiVntApiDeviceListConstMeta =>
      const TaskConstMeta(debugName: "VntApi_device_list", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiDownStreamConstMeta =>
      const TaskConstMeta(debugName: "VntApi_down_stream", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiIsStoppedConstMeta =>
      const TaskConstMeta(debugName: "VntApi_is_stopped", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiNatInfoConstMeta =>
      const TaskConstMeta(debugName: "VntApi_nat_info", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiRouteConstMeta =>
      const TaskConstMeta(debugName: "VntApi_route", argNames: ["that", "ip"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiRouteListConstMeta =>
      const TaskConstMeta(debugName: "VntApi_route_list", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiStopConstMeta =>
      const TaskConstMeta(debugName: "VntApi_stop", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiStreamAllConstMeta =>
      const TaskConstMeta(debugName: "VntApi_stream_all", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiVntApiUpStreamConstMeta =>
      const TaskConstMeta(debugName: "VntApi_up_stream", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateApiVntApiInitAppConstMeta =>
  ...
  (String, List<RustRoute>) dco_decode_record_string_list_rust_route(
    ...
    return (dco_decode_String(arr[0]), dco_decode_list_rust_route(arr[1]));
  }
  ...
  RustPeerClientInfo sse_decode_rust_peer_client_info(
    ...
    var var_currentClientSecretHash = sse_decode_list_prim_u_8_strict(
      deserializer,
    );
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVntApi(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as VntApiImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVntApi(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as VntApiImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  void sse_encode_DartFn_Inputs_rust_connect_info_Output_unit_AnyhowException(
    FutureOr<void> Function(RustConnectInfo) self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
      encode_DartFn_Inputs_rust_connect_info_Output_unit_AnyhowException(self),
      serializer,
    );
  }
  ...
  void sse_encode_DartFn_Inputs_rust_device_config_Output_u_32_AnyhowException(
    FutureOr<int> Function(RustDeviceConfig) self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
      encode_DartFn_Inputs_rust_device_config_Output_u_32_AnyhowException(self),
      serializer,
    );
  }
  ...
  void sse_encode_DartFn_Inputs_rust_device_info_Output_unit_AnyhowException(
    FutureOr<void> Function(RustDeviceInfo) self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
  ...
  void sse_encode_DartFn_Inputs_rust_error_info_Output_unit_AnyhowException(
    FutureOr<void> Function(RustErrorInfo) self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
  ...
  void sse_encode_DartFn_Inputs_rust_register_info_Output_bool_AnyhowException(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
      encode_DartFn_Inputs_rust_register_info_Output_bool_AnyhowException(self),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVntApi(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as VntApiImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_list_record_string_list_rust_route(
    List<(String, List<RustRoute>)> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
...
class VntApiImpl extends RustOpaque implements VntApi {
  ...
  RustCurrentDeviceInfo currentDevice() =>
      RustLib.instance.api.crateApiVntApiVntApiCurrentDevice(that: this);

  List<RustPeerClientInfo> deviceList() =>
      RustLib.instance.api.crateApiVntApiVntApiDeviceList(that: this);

  String downStream() =>
      RustLib.instance.api.crateApiVntApiVntApiDownStream(that: this);
  ...
  bool isStopped() =>
      RustLib.instance.api.crateApiVntApiVntApiIsStopped(that: this);

  RustNatInfo natInfo() =>
      RustLib.instance.api.crateApiVntApiVntApiNatInfo(that: this);
  ...
  List<(String, List<RustRoute>)> routeList() =>
      RustLib.instance.api.crateApiVntApiVntApiRouteList(that: this);

  void stop() => RustLib.instance.api.crateApiVntApiVntApiStop(that: this);

  List<(String, BigInt, BigInt)> streamAll() =>
      RustLib.instance.api.crateApiVntApiVntApiStreamAll(that: this);

  String upStream() =>
      RustLib.instance.api.crateApiVntApiVntApiUpStream(that: this);
